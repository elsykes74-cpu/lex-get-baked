...
import { ArrowRight, Sparkles, Cookie, Wheat, Cake, Leaf } from 'lucide-react';
...
const VALUES = [
  { Icon: Wheat,    title: 'Small Batch Quality',  desc: 'Every order is made fresh. We never mass-produce or freeze our desserts.', color: '#D4956A' },
  { Icon: Cake,     title: 'Celebration Desserts', desc: 'From birthdays to proposals, we craft moments you\'ll remember forever.',   color: '#C9748F' },
  { Icon: Leaf,     title: 'Local Ingredients',    desc: 'Sourced from Western Massachusetts farms and artisan suppliers.',            color: '#6B8C7A' },
  { Icon: Sparkles, title: 'Custom Everything',    desc: 'No order is too unique. Tell us your vision and we\'ll make it real.',      color: '#9B7EBC' },
];
        ...
        <div className="relative z-10 max-w-lg mx-auto">
          ...
          >
            ...
            <div
              ...
              style={{
                background: 'linear-gradient(135deg, rgba(255,255,255,0.72), rgba(255,242,228,0.88))',
                border: '2px solid rgba(212,149,106,0.38)',
                boxShadow: '0 8px 32px rgba(201,116,143,0.22), 0 0 0 1px rgba(255,255,255,0.65)',
                animation: 'float 6s ease-in-out infinite',
              }}
            >
              <Cookie size={36} strokeWidth={1.3} style={{ color: '#D4956A' }} />
            </div>
            <p className="text-[9px] tracking-[0.16em] uppercase font-bold mb-2 text-plum/50">Our Story</p>
            <h1 className="font-display text-4xl italic font-bold text-white mb-4"
          ...
          <div className="space-y-3 mb-10">
            {VALUES.map(({ Icon, title, desc, color }, i) => (
              <motion.div
                ...
                viewport={{ once: true }} transition={{ delay: i * 0.07, duration: 0.40 }}
